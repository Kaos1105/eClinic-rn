...
(function () {
    ...
    abp.auth.getToken = async function () {
        return await abp.utils.getCookieValue(abp.auth.tokenCookieName);
    };
    ...
    abp.auth.getRefreshToken = async function () {
        return await abp.utils.getCookieValue(abp.auth.refreshTokenCookieName);
    };
    ...
    abp.utils.setCookieValue = async function (key, value, expireDate, path, domain) {
        var cookieValue = encodeURIComponent(key) + '=';
        ...
        //document.cookie = cookieValue;
        try {
            await AsyncStorage.setItem(key, cookieValue)
        } catch (e) {
            console.log(e);
        }
    };
    ...
    abp.utils.getCookieValue = async function (key) {
        //var equalities = document.cookie.split('; ');
        let equalities;
        try {
