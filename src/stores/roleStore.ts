...
import { CreateRoleInput } from '../service/role/dto/createRoleInput';
import { EntityDto } from '../service/dto/entityDto';
import { GetAllPermissionsOutput } from '../service/role/dto/getAllPermissionsOutput';
import { GetAllRoleOutput } from '../service/role/dto/getAllRoleOutput';
import { GetRoleAsyncInput } from '../service/role/dto/getRolesAsyncInput';
import { PagedResultDto } from '../service/dto/pagedResultDto';
import { PagedRoleResultRequestDto } from '../service/role/dto/PagedRoleResultRequestDto';
import RoleEditModel from '../models/Roles/roleEditModel';
import { UpdateRoleInput } from '../service/role/dto/updateRoleInput';
